...
import com.jn.commons.entities.JnEntityRecruiterDomains;
...
public class GetRecruiterDomains {
	...
	public CcpMapDecorator apply(String firstLetters){
		...
		CcpMapTransform<CcpMapDecorator> cacheLayer = valores -> new JnEntityRecruiterDomains().getOneById(new CcpMapDecorator().put("prefix", firstLetters), values -> values.put("domains", new ArrayList<>()));
