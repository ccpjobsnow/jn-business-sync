...
public class DownloadResumeText {
	...
	public Map<String, Object> execute (String resume){
		...
		ReadResumeFromBucket cacheLayer = new ReadResumeFromBucket(this.bucket, resume, JnConstants.SLASH_TEXT);
		String cacheKey = JnCacheKeys.RESUMES_KEY + JnConstants.DOT + resume + JnConstants.SLASH_TEXT.replace("/", ".");
